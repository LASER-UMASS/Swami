...
public class VMBridge_jdk15_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.mozilla.javascript.jdk15.VMBridge_jdk15"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(VMBridge_jdk15_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.reflect.AccessibleObject", false, VMBridge_jdk15_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.mozilla.javascript.InterfaceAdapter", false, VMBridge_jdk15_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(VMBridge_jdk15_ESTest_scaffolding.class.getClassLoader()); 
