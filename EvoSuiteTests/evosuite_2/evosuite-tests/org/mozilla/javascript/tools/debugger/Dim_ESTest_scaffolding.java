...
public class Dim_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.mozilla.javascript.tools.debugger.Dim"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.mozilla.javascript.tools.debugger.ScopeProvider", false, Dim_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.mozilla.javascript.tools.debugger.SourceProvider", false, Dim_ESTest_scaffolding.class.getClassLoader()));
  }
