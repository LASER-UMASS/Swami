...
public class LazilyLoadedCtor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.mozilla.javascript.LazilyLoadedCtor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LazilyLoadedCtor_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.mozilla.javascript.Arguments$ThrowTypeError",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LazilyLoadedCtor_ESTest_scaffolding.class.getClassLoader()); 
